...
## Project Structure
    ...
    ├── scaffold_change_test_2  # Django project configurations
...
1. Clone this repo and `cd scaffold_change_test_2`
...
2. Clone this repo and `cd scaffold_change_test_2`
